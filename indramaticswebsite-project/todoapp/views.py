...
def signupuser(request):
    if request.method == "GET":
        ...
        # create a new user
        if request.POST.get('password1', False) and request.POST.get('password2',
                                                                     False):  # observed that request can be POST if refresh sometimes, not sure why? So addeed this as safeguard
            ...
            # return render(request, 'todoapp/signupuser.html', {'error': 'Reloading the page, could not find all expected fields'})
